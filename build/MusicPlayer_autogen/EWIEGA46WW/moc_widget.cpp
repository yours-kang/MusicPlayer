...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'eventFilter'
        QtMocHelpers::SlotData<bool(QObject *, QEvent *)>(11, 2, QMC::AccessPrivate, QMetaType::Bool, {{
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'PlayMode'
        QtMocHelpers::EnumData<PlayMode>(15, 15, QMC::EnumFlags{}).add({
            {   16, PlayMode::Sequence },
            {   17, PlayMode::Loop },
            {   18, PlayMode::Random },
        }),
    };
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->on_listWidget_doubleClicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
